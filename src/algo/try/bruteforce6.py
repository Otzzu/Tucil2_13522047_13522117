...
class BezierCurve6Points:
    def __init__(self, P0, P1, P2, P3, P4, P5,num_iterate):
        self.P0 = P0
        self.P1 = P1
        self.P2 = P2
        self.P3 = P3
    ...
    def _bezier_curve(self, num_points):
        ...
        for t in range(num_points):
            t /= num_points - 1
            x = (1 - t)**5 * self.P0[0] + 5 * t * (1 - t)**4 * self.P1[0] + 10 * t**2 * (1 - t)**3 * self.P2[0] + 10 * t**3 * (1 - t)**2 * self.P3[0] + 5 * t**4 * (1 - t) * self.P4[0] + t**5 * self.P5[0]
            y = (1 - t)**5 * self.P0[1] + 5 * t * (1 - t)**4 * self.P1[1] + 10 * t**2 * (1 - t)**3 * self.P2[1] + 10 * t**3 * (1 - t)**2 * self.P3[1] + 5 * t**4 * (1 - t) * self.P4[1] + t**5 * self.P5[1]
    ...
    def draw_animation_curve(self, fig, ax):
        ...
        ax.scatter([self.P0[0], self.P1[0], self.P2[0], self.P3[0], self.P4[0], self.P5[0]], [self.P0[1], self.P1[1], self.P2[1], self.P3[1], self.P4[1], self.P5[1]], color='red')
        ax.plot([self.P0[0], self.P1[0], self.P2[0], self.P3[0], self.P4[0], self.P5[0]], [self.P0[1], self.P1[1], self.P2[1], self.P3[1], self.P4[1], self.P5[1]], '-ro', label='Control Points')
        ...
        def animate_curve(i):
            ...
            return line_curve, line_P0_P1, line_P1_P2, line_P2_P3, line_P3_P4, line_P4_P5
    ...
    def draw_curve(self, ax):
        ctrl_x = [self.P0[0], self.P1[0], self.P2[0], self.P3[0], self.P4[0], self.P5[0]]
        ctrl_y = [self.P0[1], self.P1[1], self.P2[1], self.P3[1], self.P4[1], self.P5[1]]
