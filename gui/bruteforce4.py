...
class BezierCurve4Points:
    def __init__(self, P0, P1, P2, P3, num_iterate):
        self.P0 = P0
        self.P1 = P1
        self.P2 = P2
        self.P3 = P3
        ...
        self.curve_points = self._cubic_bezier_curve(self.num_points)
    ...
    def _cubic_bezier_curve(self, num_points):
        curve_points = []
    ...
    def draw_animation_curve(self, fig, ax):
        ...
        ax.scatter([self.P0[0], self.P1[0], self.P2[0], self.P3[0]], [self.P0[1], self.P1[1], self.P2[1], self.P3[1]], color='red')
        ax.plot([self.P0[0], self.P1[0], self.P2[0], self.P3[0]], [self.P0[1], self.P1[1], self.P2[1], self.P3[1]], '-ro', label='Control Points')
        ...
        def animate_curve(i):
            ...
            return line_curve, line_P0_P1, line_P1_P2, line_P2_P3
    ...
    def draw_curve(self, ax):
        ctrl_x = [self.P0[0], self.P1[0], self.P2[0], self.P3[0]]
        ctrl_y = [self.P0[1], self.P1[1], self.P2[1], self.P3[1]]
